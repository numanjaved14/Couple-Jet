        ...
        children: [
              ...
              itemBuilder: (context, int index) {
                return Container(
                  decoration: BoxDecoration(
                      ...
                      borderRadius:
                          BorderRadius.all(Radius.circular(16 * widthScale))),
                );
              }),
          Align(
            ...
            child: Container(
                margin: EdgeInsets.only(
                    right: 20 * widthScale, top: 20 * widthScale),
                ...
                child: Text(
                  '${(currentPhotoIndex + 1)}/${widget.imgList.length}',
                  style: GoogleFonts.outfit(
                      fontSize: 12 * widthScale, color: Colors.white),
                )),
          ),
          Align(
          ...
          Align(
            ...
            child: GestureDetector(
              ...
              child: Container(
                  margin: EdgeInsets.only(
                      left: 20 * widthScale, bottom: 22 * widthScale),
                  padding: EdgeInsets.only(right: 15 * widthScale),
                  decoration: BoxDecoration(
                      color: Colors.black.withOpacity(0.4),
                      borderRadius:
                          BorderRadius.all(Radius.circular(30 * widthScale))),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      GradientRoundButton(
                          icon: Icons.favorite_rounded, onPress: () {}),
                      SizedBox(
                        width: 8 * widthScale,
                      ),
                      Text(
